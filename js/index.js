...
$(document).ready(function () {
    ...
    $("#exodia").click(function (event) {
        ...
        setData({
            ...
            "cards": [{
                ...
                "numInDeck": 1,
                "numRequired": 1
            }, {"name": "Left Arm of the Forbidden One", "numInDeck": 1, "numRequired": 1}]
        });
    });
    $("#channelFireball").click(function (event) {
        ...
        setData({
            "deckSize": 60,
            "handSize": 7,
            "cards": [{"name": "Black Lotus", "numInDeck": 1, "numRequired": 1}, {
                "name": "Channel",
                "numInDeck": 1,
                "numRequired": 1
            }, {"name": "Fireball", "numInDeck": 4, "numRequired": 1}, {
                "name": "Mountain",
                "numInDeck": 24,
                "numRequired": 1
            }]
    ...
    $("#leyline").click(function (event) {
        ...
        setData({
            "deckSize": 60,
            "handSize": 7,
            "cards": [{"name": "Leyline of Sanctity", "numInDeck": 4, "numRequired": 1}]
        });
    });
    $("#birdsOfParadise").click(function (event) {
        ...
        setData({
            "deckSize": 60,
            "handSize": 7,
            "cards": [{"name": "Birds of Paradise", "numInDeck": 4, "numRequired": 1}, {
                "name": "Forest",
                "numInDeck": 24,
                "numRequired": 1
            }]
