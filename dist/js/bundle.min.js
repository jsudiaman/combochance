...
"use strict";var _=require("lodash"),math=require("./math.js"),MAX_N=26,MONTE_CARLO_TRIALS=1e4;exports.getSumRequired=function(e){return _.reduce(e.cards,function(e,r){return e+r.numRequired},0)},exports.getSumInDeck=function(e){return _.reduce(e.cards,function(e,r){return e+r.numInDeck},0)},exports.getChance=function(e){var r=0,n=e.handSize-this.getSumRequired(e),t=JSON.stringify(e.cards);try{for(var u=[],a=0;a<e.cards.length;a++)for(var c=e.cards[a],i=0;i<c.numInDeck-c.numRequired;i++)u.push(a);if(u.length>MAX_N&&n>1)return{percent:100*this.getChance3(e),experimental:!0};for(var s=math.powerset(u,n),h=0;h<s.length;h++){for(var o=s[h],d=0;d<o.length;d++)e.cards[o[d]].numRequired++;r+=this.getChance2(e),e.cards=JSON.parse(t)}}finally{e.cards=JSON.parse(t)}var f={percent:100*r,experimental:!1},m=f.percent,p=f.experimental;return m>=99.9&&m<100?{percent:99.9,experimental:p}:{percent:m,experimental:p}},exports.getChance2=function(e){return _.reduce(e.cards,function(e,r){return e*math.choose(r.numInDeck,r.numRequired)},math.choose(e.deckSize-this.getSumInDeck(e),e.handSize-this.getSumRequired(e)))/math.choose(e.deckSize,e.handSize)},exports.getChance3=function(e){var r=0,n=[],t=[];_.forEach(e.cards,function(e){for(var r=0;r<e.numInDeck;r++)n.push(e);for(var u=0;u<e.numRequired;u++)t.push(e)});for(var u=0,a=n.length;u<e.deckSize-a;u++)n.push({});for(var c=0;c<MONTE_CARLO_TRIALS;c++){var i=_.shuffle(n).slice(0,e.handSize);0===_.difference(t,i).length&&r++}return r/MONTE_CARLO_TRIALS};

},{"./math.js":4,"lodash":19}],2:[function(require,module,exports){
