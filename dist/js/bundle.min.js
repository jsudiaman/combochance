...
"use strict";var _=require("lodash"),common={};common.getSumRequired=function(e){return _.reduce(e.cards,function(e,n){return e+n.numRequired},0)},common.getSumInDeck=function(e){return _.reduce(e.cards,function(e,n){return e+n.numInDeck},0)},module.exports=common;

},{"lodash":19}],2:[function(require,module,exports){
"use strict";!function(i){(jQuery.browser=jQuery.browser||{}).mobile=/(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino/i.test(i)||/1207|6310|6590|3gso|4thp|50[1-6]i|770s|802s|a wa|abac|ac(er|oo|s\-)|ai(ko|rn)|al(av|ca|co)|amoi|an(ex|ny|yw)|aptu|ar(ch|go)|as(te|us)|attw|au(di|\-m|r |s )|avan|be(ck|ll|nq)|bi(lb|rd)|bl(ac|az)|br(e|v)w|bumb|bw\-(n|u)|c55\/|capi|ccwa|cdm\-|cell|chtm|cldc|cmd\-|co(mp|nd)|craw|da(it|ll|ng)|dbte|dc\-s|devi|dica|dmob|do(c|p)o|ds(12|\-d)|el(49|ai)|em(l2|ul)|er(ic|k0)|esl8|ez([4-7]0|os|wa|ze)|fetc|fly(\-|_)|g1 u|g560|gene|gf\-5|g\-mo|go(\.w|od)|gr(ad|un)|haie|hcit|hd\-(m|p|t)|hei\-|hi(pt|ta)|hp( i|ip)|hs\-c|ht(c(\-| |_|a|g|p|s|t)|tp)|hu(aw|tc)|i\-(20|go|ma)|i230|iac( |\-|\/)|ibro|idea|ig01|ikom|im1k|inno|ipaq|iris|ja(t|v)a|jbro|jemu|jigs|kddi|keji|kgt( |\/)|klon|kpt |kwc\-|kyo(c|k)|le(no|xi)|lg( g|\/(k|l|u)|50|54|\-[a-w])|libw|lynx|m1\-w|m3ga|m50\/|ma(te|ui|xo)|mc(01|21|ca)|m\-cr|me(rc|ri)|mi(o8|oa|ts)|mmef|mo(01|02|bi|de|do|t(\-| |o|v)|zz)|mt(50|p1|v )|mwbp|mywa|n10[0-2]|n20[2-3]|n30(0|2)|n50(0|2|5)|n7(0(0|1)|10)|ne((c|m)\-|on|tf|wf|wg|wt)|nok(6|i)|nzph|o2im|op(ti|wv)|oran|owg1|p800|pan(a|d|t)|pdxg|pg(13|\-([1-8]|c))|phil|pire|pl(ay|uc)|pn\-2|po(ck|rt|se)|prox|psio|pt\-g|qa\-a|qc(07|12|21|32|60|\-[2-7]|i\-)|qtek|r380|r600|raks|rim9|ro(ve|zo)|s55\/|sa(ge|ma|mm|ms|ny|va)|sc(01|h\-|oo|p\-)|sdk\/|se(c(\-|0|1)|47|mc|nd|ri)|sgh\-|shar|sie(\-|m)|sk\-0|sl(45|id)|sm(al|ar|b3|it|t5)|so(ft|ny)|sp(01|h\-|v\-|v )|sy(01|mb)|t2(18|50)|t6(00|10|18)|ta(gt|lk)|tcl\-|tdg\-|tel(i|m)|tim\-|t\-mo|to(pl|sh)|ts(70|m\-|m3|m5)|tx\-9|up(\.b|g1|si)|utst|v400|v750|veri|vi(rg|te)|vk(40|5[0-3]|\-v)|vm40|voda|vulc|vx(52|53|60|61|70|80|81|83|85|98)|w3c(\-| )|webc|whit|wi(g |nc|nw)|wmlb|wonu|x700|yas\-|your|zeto|zte\-/i.test(i.substr(0,4))}(navigator.userAgent||navigator.vendor||window.opera);

},{}],3:[function(require,module,exports){
(function (global){
"use strict";function getData(){var e={};e.deckSize=parseInt($("#deckSize").val()),e.handSize=parseInt($("#handSize").val()),e.cards=[];for(var n=0;n<nRows;n++){var a=$("#name"+n).val(),t=$("#aid"+n).val(),r=$("#ar"+n).val();e.cards.push({name:a,numInDeck:parseInt(t),numRequired:parseInt(r)})}return e}function handle(e){$("#results").html('<div class="alert alert-danger">'+e+"</div>")}function addRow(){var e=nRows;$("#card"+e).html('<td><input type="text" id="name'+e+'" placeholder="Card Name" class="form-control"/></td><td><input type="number" id="aid'+e+'" class="form-control num"/></td><td><input type="number" id="ar'+e+'" class="form-control num"/></td>'),$("#name"+e).val(sessionStorage.getItem("name"+e)||"").change(function(){sessionStorage.setItem("name"+e,$(this).val())}),$("#aid"+e).val(sessionStorage.getItem("id"+e)||1).change(function(){sessionStorage.setItem("id"+e,$(this).val())}),$("#ar"+e).val(sessionStorage.getItem("req"+e)||1).change(function(){sessionStorage.setItem("req"+e,$(this).val())}),$("#tab_logic").append('<tr id="card'+(e+1)+'"></tr>'),nRows++}function deleteRow(){nRows>1&&($("#card"+(nRows-1)).html(""),nRows--)}function setData(e){for(var n=e.cards.length||1;nRows<n;)addRow();for(;nRows>n;)deleteRow();for(var a=0;a<n;a++)$("#name"+a).val(e.cards[a].name),$("#aid"+a).val(e.cards[a].numInDeck),$("#ar"+a).val(e.cards[a].numRequired),sessionStorage.setItem("name"+a,e.cards[a].name),sessionStorage.setItem("id"+a,e.cards[a].numInDeck),sessionStorage.setItem("req"+a,e.cards[a].numRequired);$("#deckSize").val(e.deckSize),$("#handSize").val(e.handSize),sessionStorage.setItem("rows",n),$("#primaryForm").submit()}var $=global.jQuery=global.$=require("jquery");require("bootstrap"),require("./detectmobilebrowser.js");var _=require("lodash"),common=require("./common.js"),math=require("./math.js"),sessionStorage=window.sessionStorage,nRows=1,MAX_DECK_SIZE=1e3;$(".collapse").collapse(),$('[data-toggle="tooltip"]').tooltip();for(var i=1;i<sessionStorage.getItem("rows");i++)addRow();$("#add_row").click(function(){addRow(),sessionStorage.setItem("rows",nRows)}),$("#delete_row").click(function(){deleteRow(),sessionStorage.setItem("rows",nRows)}),$("#primaryForm").submit(function(e){e.preventDefault();var n=getData();if(n.handSize>n.deckSize)handle("Your hand size is bigger than your deck size.");else if(n.deckSize<common.getSumInDeck(n))handle('Your deck size is too small, check your "Amount in Deck" values.');else if(n.handSize<common.getSumRequired(n))handle("Your hand size is too small for this combo.");else if(_.some(document.getElementsByClassName("num"),function(e){return""===e.value}))handle('Check your "Amount in Deck" and "Amount Required" values. One of them is not a number.');else if(n.deckSize>MAX_DECK_SIZE)handle("If your deck has "+n.deckSize+" cards, I wouldn't suggest playing combo.");else try{var a=math.getChance(n);$("#results").empty().append("Combo: ").append(_.map(n.cards,function(e){return e.numRequired+"x "+(e.name.length>0?e.name:"Unnamed Card")}).join(", ")).append("<br>Deck Size: "+n.deckSize).append(", Cards in Hand: "+n.handSize).append("<br><br>The chance of you pulling this off is"+(a.experimental?' <a href="#" data-toggle="modal" data-target="#approximately">approximately</a> ':" ")).append(Number(a.percent).toPrecision(3)+"%.")}catch(e){handle(e)}finally{$.browser.mobile||window.scrollTo(0,document.body.scrollHeight)}}),$("#clear").click(function(){$("input").each(function(e,n){for(/^(aid|ar).*$/.test(n.id)?n.value=1:n.value="";nRows>1;)deleteRow();sessionStorage.clear()}),document.getElementById("results").innerHTML=""}),$("#exodia").click(function(e){e.preventDefault(),setData({deckSize:40,handSize:5,cards:[{name:"Exodia the Forbidden One",numInDeck:1,numRequired:1},{name:"Right Leg of the Forbidden One",numInDeck:1,numRequired:1},{name:"Left Leg of the Forbidden One",numInDeck:1,numRequired:1},{name:"Right Arm of the Forbidden One",numInDeck:1,numRequired:1},{name:"Left Arm of the Forbidden One",numInDeck:1,numRequired:1}]})}),$("#channelFireball").click(function(e){e.preventDefault(),setData({deckSize:60,handSize:7,cards:[{name:"Black Lotus",numInDeck:1,numRequired:1},{name:"Channel",numInDeck:1,numRequired:1},{name:"Fireball",numInDeck:4,numRequired:1},{name:"Mountain",numInDeck:24,numRequired:1}]})}),$("#leyline").click(function(e){e.preventDefault(),setData({deckSize:60,handSize:7,cards:[{name:"Leyline of Sanctity",numInDeck:4,numRequired:1}]})}),$("#birdsOfParadise").click(function(e){e.preventDefault(),setData({deckSize:60,handSize:7,cards:[{name:"Birds of Paradise",numInDeck:4,numRequired:1},{name:"Forest",numInDeck:24,numRequired:1}]})});
...
"use strict";function getChance2(e){return _.reduce(e.cards,function(e,r){return e*math.choose(r.numInDeck,r.numRequired)},math.choose(e.deckSize-common.getSumInDeck(e),e.handSize-common.getSumRequired(e)))/math.choose(e.deckSize,e.handSize)}function getChance3(e){var r=0,n=[],t=[],a=void 0;_.forEach(e.cards,function(e){for(var r=0;r<e.numInDeck;r++)n.push(e);for(var a=0;a<e.numRequired;a++)t.push(e)});for(var o=0,c=n.length;o<e.deckSize-c;o++)n.push({});for(var i=0;i<MONTE_CARLO_TRIALS;i++)a=_.shuffle(n).slice(0,e.handSize),0===_.difference(t,a).length&&r++;return r/MONTE_CARLO_TRIALS}var _=require("lodash"),common=require("./common.js"),MAX_N=26,MAX_PASCAL=1e4,MONTE_CARLO_TRIALS=1e3,math={};math.powerset=function(e,r){var n=[[]];if(0===r)return n;if(1===r)n=n.concat(_.map(e,function(e){return[e]}));else{if(e.length>MAX_N)throw new Error("This would require processing a very large power set (2^"+e.length+" elements).");for(var t=0;t<e.length;t++)for(var a=0,o=n.length;a<o;a++)(void 0===r||n[a].length<r)&&n.push(n[a].concat(e[t]))}return _.uniqWith(n,function(e,r){if(!r)return!1;if(e.length!==r.length)return!1;for(var n=0,t=e.length;n<t;n++)if(e[n]!==r[n])return!1;return!0})},math.createPascalTriangle=function(e){e++;for(var r=[],n=0;n<e;n++){r[n]=new Array(n+1);for(var t=0;t<n+1;t++)r[n][t]=0===t||t===n?1:r[n-1][t-1]+r[n-1][t]}return r};var ptRows=0,pascalTriangle=math.createPascalTriangle(ptRows);math.choose=function(e,r){if(r>e)return 0;if(e>MAX_PASCAL)throw RangeError("n is too large");if(e<0||r<0)throw RangeError("Please use positive numbers.");return e>ptRows&&(ptRows=e,pascalTriangle=math.createPascalTriangle(e)),pascalTriangle[e][r]},math.getChance=function(e){var r=0,n=e.handSize-_.reduce(e.cards,function(e,r){return e+r.numRequired},0),t=JSON.stringify(e.cards);try{for(var a=[],o=0;o<e.cards.length;o++)for(var c=e.cards[o],i=0;i<c.numInDeck-c.numRequired;i++)a.push(o);if(a.length>MAX_N&&n>1)return{percent:100*getChance3(e),experimental:!0};for(var u=math.powerset(a,n),h=0;h<u.length;h++){for(var s=u[h],l=0;l<s.length;l++)e.cards[s[l]].numRequired++;r+=getChance2(e),e.cards=JSON.parse(t)}}finally{e.cards=JSON.parse(t)}var f={percent:100*r,experimental:!1},m=f.percent,g=f.experimental;return m>=99.9&&m<100?{percent:99.9,experimental:g}:{percent:m,experimental:g}},module.exports=math;
...
+function(t){"use strict";function i(i){return this.each(function(){var o=t(this),f=o.data("bs.affix"),n="object"==typeof i&&i;f||o.data("bs.affix",f=new e(this,n)),"string"==typeof i&&f[i]()})}var e=function(i,o){this.options=t.extend({},e.DEFAULTS,o),this.$target=t(this.options.target).on("scroll.bs.affix.data-api",t.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",t.proxy(this.checkPositionWithEventLoop,this)),this.$element=t(i),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};e.VERSION="3.3.7",e.RESET="affix affix-top affix-bottom",e.DEFAULTS={offset:0,target:window},e.prototype.getState=function(t,i,e,o){var f=this.$target.scrollTop(),n=this.$element.offset(),s=this.$target.height();if(null!=e&&"top"==this.affixed)return f<e&&"top";if("bottom"==this.affixed)return null!=e?!(f+this.unpin<=n.top)&&"bottom":!(f+s<=t-o)&&"bottom";var a=null==this.affixed,h=a?f:n.top;return null!=e&&f<=e?"top":null!=o&&h+(a?s:i)>=t-o&&"bottom"},e.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(e.RESET).addClass("affix");var t=this.$target.scrollTop(),i=this.$element.offset();return this.pinnedOffset=i.top-t},e.prototype.checkPositionWithEventLoop=function(){setTimeout(t.proxy(this.checkPosition,this),1)},e.prototype.checkPosition=function(){if(this.$element.is(":visible")){var i=this.$element.height(),o=this.options.offset,f=o.top,n=o.bottom,s=Math.max(t(document).height(),t(document.body).height());"object"!=typeof o&&(n=f=o),"function"==typeof f&&(f=o.top(this.$element)),"function"==typeof n&&(n=o.bottom(this.$element));var a=this.getState(s,i,f,n);if(this.affixed!=a){null!=this.unpin&&this.$element.css("top","");var h="affix"+(a?"-"+a:""),r=t.Event(h+".bs.affix");if(this.$element.trigger(r),r.isDefaultPrevented())return;this.affixed=a,this.unpin="bottom"==a?this.getPinnedOffset():null,this.$element.removeClass(e.RESET).addClass(h).trigger(h.replace("affix","affixed")+".bs.affix")}"bottom"==a&&this.$element.offset({top:s-i-n})}};var o=t.fn.affix;t.fn.affix=i,t.fn.affix.Constructor=e,t.fn.affix.noConflict=function(){return t.fn.affix=o,this},t(window).on("load",function(){t('[data-spy="affix"]').each(function(){var e=t(this),o=e.data();o.offset=o.offset||{},null!=o.offsetBottom&&(o.offset.bottom=o.offsetBottom),null!=o.offsetTop&&(o.offset.top=o.offsetTop),i.call(e,o)})})}(jQuery);
