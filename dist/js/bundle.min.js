...
"use strict";var _=require("lodash");exports.getSumRequired=function(e){return _.reduce(e.cards,function(e,r){return e+r.numRequired},0)},exports.getSumInDeck=function(e){return _.reduce(e.cards,function(e,r){return e+r.numInDeck},0)};
...
"use strict";var _=require("lodash"),common=require("./common.js"),MAX_N=26,MAX_PASCAL=1e4,MONTE_CARLO_TRIALS=1e3;exports.powerset=function(e,r){var n=[[]];if(0===r)return n;if(1===r)n=n.concat(_.map(e,function(e){return[e]}));else{if(e.length>MAX_N)throw new Error("This would require processing a very large power set (2^"+e.length+" elements).");for(var t=0;t<e.length;t++)for(var a=0,i=n.length;a<i;a++)(void 0===r||n[a].length<r)&&n.push(n[a].concat(e[t]))}return _.uniqWith(n,function(e,r){if(!r)return!1;if(e.length!==r.length)return!1;for(var n=0,t=e.length;n<t;n++)if(e[n]!==r[n])return!1;return!0})},exports.createPascalTriangle=function(e){e++;for(var r=[],n=0;n<e;n++){r[n]=new Array(n+1);for(var t=0;t<n+1;t++)r[n][t]=0===t||t===n?1:r[n-1][t-1]+r[n-1][t]}return r},exports.ptRows=0,exports.pascalTriangle=exports.createPascalTriangle(exports.ptRows),exports.choose=function(e,r){if(r>e)return 0;if(e>MAX_PASCAL)throw RangeError("n is too large");if(e<0||r<0)throw RangeError("Please use positive numbers.");return e>this.ptRows&&(this.ptRows=e,this.pascalTriangle=this.createPascalTriangle(e)),this.pascalTriangle[e][r]},exports.getChance=function(e){var r=0,n=e.handSize-_.reduce(e.cards,function(e,r){return e+r.numRequired},0),t=JSON.stringify(e.cards);try{for(var a=[],i=0;i<e.cards.length;i++)for(var o=e.cards[i],s=0;s<o.numInDeck-o.numRequired;s++)a.push(i);if(a.length>MAX_N&&n>1)return{percent:100*this.getChance3(e),experimental:!0};for(var c=this.powerset(a,n),u=0;u<c.length;u++){for(var h=c[u],l=0;l<h.length;l++)e.cards[h[l]].numRequired++;r+=this.getChance2(e),e.cards=JSON.parse(t)}}finally{e.cards=JSON.parse(t)}var f={percent:100*r,experimental:!1},p=f.percent,g=f.experimental;return p>=99.9&&p<100?{percent:99.9,experimental:g}:{percent:p,experimental:g}},exports.getChance2=function(e){var r=this;return _.reduce(e.cards,function(e,n){return e*r.choose(n.numInDeck,n.numRequired)},this.choose(e.deckSize-common.getSumInDeck(e),e.handSize-common.getSumRequired(e)))/this.choose(e.deckSize,e.handSize)},exports.getChance3=function(e){var r=0,n=[],t=[],a=void 0;_.forEach(e.cards,function(e){for(var r=0;r<e.numInDeck;r++)n.push(e);for(var a=0;a<e.numRequired;a++)t.push(e)});for(var i=0,o=n.length;i<e.deckSize-o;i++)n.push({});for(var s=0;s<MONTE_CARLO_TRIALS;s++)a=_.shuffle(n).slice(0,e.handSize),0===_.difference(t,a).length&&r++;return r/MONTE_CARLO_TRIALS};
